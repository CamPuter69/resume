...
# Route for Resume Analysis (resume.html)
@app.route('/resume', methods=['GET', 'POST'])
def resume():
    if request.method == 'POST':
        # Perform the operations related to resume.html here
        return render_template('resume.html')  # Update with necessary data if needed
    return render_template('resume.html')

# Route for Resume Matcher (resumematcher.html)
@app.route('/resumematcher', methods=['GET', 'POST'])
def resumematcher():
    if request.method == 'POST':
        # Perform the operations related to resumematcher.html here
        return render_template('resumematcher.html')  # Update with necessary_
...
def cleanResume(txt):
    ...
    # Fix for invalid escape sequence '\]': Use raw string for re.escape
    special_chars = r"""!"#$%&'()*+,-./:;<=>?@[\]^_`{|}~"""
